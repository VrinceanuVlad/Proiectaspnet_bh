...
namespace Proiectdaw.Migrations
{
    ...
    [Migration("20220831143735_AddedSessionToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proiectdaw.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proiectdaw.Entities.SessionToken", b =>
                {
            ...
            modelBuilder.Entity("Proiectdaw.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Proiectdaw.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Proiectdaw.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Proiectdaw.Entities.SessionToken", b =>
                {
                    b.HasOne("Proiectdaw.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Proiectdaw.Entities.UserRole", b =>
                {
                    ...
                    b.HasOne("Proiectdaw.Entities.Role", "Role")
                        .WithMany("UserRoles")
                    ...
                    b.HasOne("Proiectdaw.Entities.UserRole", null)
                        .WithMany("UserRoles")
